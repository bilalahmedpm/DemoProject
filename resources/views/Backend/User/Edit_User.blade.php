			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					...
					<div class="controls">
					<input type="text" name="username" class="form-control" required="" value="{{$users->name}}" data-validation-required-message="This field is required" autocomplete="off"> <div class="help-block"></div></div>
					</div>
					...
					<div class="row"><!--  Row 2  -->
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="controls">
									<input type="email" name="useremail" class="form-control" required="" value="{{$users->email}}" data-validation-required-message="This field is required"autocomplete="off">
